...
func GetFCReconciler(scheme *runtime.Scheme, namespace string, crdClient *v1alpha1.CRDClient, clusterId *clusterID.ClusterID, requeueAfter time.Duration, discoveryCtrl *discovery.DiscoveryCtrl) *ForeignClusterReconciler {
